...
@FileName: app.py
@DateTime: 2026-02-08
@Docs: FastAPI app with import/export endpoints using SQLModel.
使用 SQLModel 的 FastAPI 导入导出端点示例。
"""
...
def create_app(
    ...
    """Create the SQLModel example app.
    创建 SQLModel 示例应用。
    """
    assert session_factory is not None, "session_factory is required / session_factory 必须提供"
    factory = session_factory
    app = FastAPI(title="SQLModel E2E Example")
